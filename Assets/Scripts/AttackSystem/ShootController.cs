...
public class ShootController : MonoBehaviour
{
    ...
    [SerializeField]List<Projectile> CurrentProjectileBlock = new();//当前子弹块
    [SerializeField]List<Gain> CurrentGainsBlock = new();//当前增益块
    float Cooldown = 0;//冷却时间
    float LastShootTime = -1;//上次射击时间
    [SerializeField]int BlockHeadIndex = 0;//当前子弹块起始位置
    #endregion
